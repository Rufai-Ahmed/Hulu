...
const ActualMovie = () => {
  ...
  const details = rowOne[params.id - 1];
  return (
    <div>
      <Header />
      <Container bg={details.Img}>
        <Wrapper bcc={details.bcc}>
          <TextHolder>
            <Text>
              <LittleT>
              ...
              <Star>
                <b>Starring:</b> {details.Star}
              </Star>
              <Director>
                <b>Director:</b> Brian Duffield
              </Director>
              <Genre>{details.SmallTxt}</Genre>
              <BtnHold>
                <Button text="5.2" />
                <Button text="DA" />
                <Button text="HD" />
